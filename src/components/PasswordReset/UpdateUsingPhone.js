...
class UpdatePassword extends Component {
    ...
    handleChange = (_, data) => {
        ...
        return data.value === "" || (/^\d+$/.test(data.value) && data.value.length === 1) ?
            this.setState({
                                    ...
                                    <div className="">
                                        ...
                                        <Grid>
                                            ...
                                            <Grid.Column width={10}>
                                                <div>
                                                    <p className="text-digits">Enter the six digits we have sent you via SMS</p>
                                                    <Form className="form-digits">
                                                        ...
                                                        <Form.Input
                                                            ...
                                                            value={form.six || ""}
                                                        />
                                                        <Btn className="btn-sign-in">UPDATE</Btn>
