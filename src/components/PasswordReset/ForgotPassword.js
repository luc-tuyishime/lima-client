                                            ...
                                            <Grid.Column width={8}>
                                                ...
                                                <Grid className="check-container">
                                                    <Grid.Column floated='left' width={5}>
                                                        <Checkbox className="email-checkbox" label={{ children: 'Email' }} />
                                                    </Grid.Column>
                                                    <Grid.Column floated='right' width={5}>
                                                        <Checkbox className="email-checkbox" label={{ children: 'Phone' }} />
                                                    </Grid.Column>
                                                </Grid>
                                                <Form>
                                                    <Form.Field className="email-reset">
                                                        <label>Enter Email</label>
                                                        <input type="text" className="input-email" placeholder='enter email' />
                                                    </Form.Field>
                                                    <Btn className="btn-sign-in" type='submit'>SEND</Btn>
                                                </Form>
                                            </Grid.Column>
                                            <Grid.Column width={4} />
                                        </Grid>
